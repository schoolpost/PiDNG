...
def convertVideo(inputFilename, outputFilenameFormat, width, length, colour, bpp):
    ...
    mainIFD.tags.append(dngTag(Tag.StripByteCounts          , [((width * 10)/8) * length]))
    ...
    mainIFD.tags.append(dngTag(Tag.WhiteLevel               , [1023]))
    ...
    dngTemplate.ImageDataStrips[0] = pack10(rawFrame).tobytes()
    dngTemplate.write()
